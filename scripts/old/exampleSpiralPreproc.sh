...
dwifslpreproc $outdir/DWI_in.mif $outdir/DWI_out.mif -rpe_none -pe_dir ap -readout_time 0.001 -eddy_slspec $slspec -eddyqc_all $outdir -eddy_options " --flm=linear --repol --data_is_shelled --mporder=13 --ol_type=both "
